...
function cambiarFondoApellidos(apellidos)
{
    ...
    if(apellidos.value.match(/^[a-zA-Z]+\s[a-zA-Z]+$/))
    {
...
//document.getElementsByTagName("select")[0].onchange=cambiarFondoAnyos;
document.getElementById("anyoFecha").onblur=cambiarFondoAnyos;
