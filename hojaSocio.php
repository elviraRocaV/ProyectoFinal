...
{
    echo $cliente->usuarioSocio;
    echo $cliente->apellidoSocio;
    echo $cliente->dniSocio;
    echo $cliente->diaFecha;
    echo $cliente->mesFecha;
    echo $cliente->anyoFecha;
    echo $cliente->direccionSocio;
    echo $cliente->numeroSocio;
    echo $cliente->portalSocio;
    echo $cliente->pisoSocio;
    echo $cliente->pisoSocio;
    echo $cliente->letraSocio;
    echo $cliente->poblacionSocio;
    echo $cliente->CPSocio;
    echo $cliente->provinciaSocio;
    echo $cliente->correoSocio;
    echo $cliente->telefono1Socio;
    echo $cliente->telefono2Socio;
    echo $cliente->cantidadSocio;
    echo $cliente->ibaSocio;
    echo $cliente->bancoSocio;
    echo $cliente->oficinaSocio;
    echo $cliente->DCSocio;
    echo $cliente->cuentaSocio;
}
$stmt->execute();
